...
```
A .yaml file has also been included which triggers via Github Actions whenever a new merge to master is done. By default, it executes with chromium and in headless mode. This can be changed in Settings > Secrets and Variables
